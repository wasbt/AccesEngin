...
{
    public class NullableRoundedDatePicker : DatePicker
    {
        public NullableRoundedDatePicker()
        {
            Format = "d";
        }
        ...
        public static readonly BindableProperty PlaceHolderProperty =
            BindableProperty.Create(nameof(PlaceHolder), typeof(string), typeof(NullableRoundedDatePicker), "/ . / . /");
        ...
        BindableProperty.Create(nameof(NullableDate), typeof(DateTime?), typeof(NullableRoundedDatePicker), null, defaultBindingMode: BindingMode.TwoWay);
