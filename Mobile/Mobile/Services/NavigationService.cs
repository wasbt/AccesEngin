...
namespace Mobile.Services
{
    public class NavigationService : INavigationService
    {
        ...
        private readonly Stack<MasterDetailPage> _navigationMasterDetailStack =
            new Stack<MasterDetailPage>();
        private NavigationPage CurrentNavigationPage => _navigationPageStack.Peek();
        private MasterDetailPage CurrentNavigationMasterDetailPage => _navigationMasterDetailStack.Peek();
        ...
        public async Task NavigateMasterDetailAsync(string pageKey, bool animated = true)
        {
            await NavigateMasterDetailAsync(pageKey, null, animated);
        }

        public async Task NavigateMasterDetailAsync(string pageKey, object parameter, bool animated = true)
        {
