CREATE TABLE [AccesEngins].[REF_TypeEngin] (
    ...
    CONSTRAINT [FK_AccesEngins.TypeEngin_AccesEngins.TypeCheckList_TypeCheckListId] FOREIGN KEY ([TypeCheckListId]) REFERENCES [AccesEngins].[REF_TypeCheckList] ([Id])
);
