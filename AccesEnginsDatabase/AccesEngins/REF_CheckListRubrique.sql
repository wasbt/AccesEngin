CREATE TABLE [AccesEngins].[REF_CheckListRubrique] (
    ...
    CONSTRAINT [FK_AccesEngins.CheckListRubrique_AccesEngins.TypeCheckList_TypeCheckListId] FOREIGN KEY ([TypeCheckListId]) REFERENCES [AccesEngins].[REF_TypeCheckList] ([Id])
);
